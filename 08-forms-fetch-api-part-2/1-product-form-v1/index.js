    ...
    return `<div class="product-form">
      <form data-element="productForm" class="form-grid">
        ...
        <div class="form-group form-group__half_left">
          ...
          <select class="form-control" id="subcategory" name="subcategory" value=${escapeHtml(this.data.subcategory)}>
  ...
  getSubcategories(){
    ...
    return this.subcategories.map(category => {
      return category.subcategories.map(item => {
        return `<option value="${category.id}"> ${category.title} &gt; ${item.title}</option>`;
      }).join('');
    }).join('');
